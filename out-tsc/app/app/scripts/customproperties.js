...
var CustomProperties = (function () {
    ...
    CustomProperties.prototype.triggerEvents = function (addInfo) {
        ...
        for (var i = 0; i < keys.length; i++) {
            ...
            var removeButton = new Button({ iconCss: 'sf-icon-Delete', cssClass: keys[i] });
            ...
            var checkboxTooltip = new CheckBox({ checked: Boolean(addInfo1[keys[i]].checked), cssClass: keys[i] });
