...
export class PageCreation {
    ...
    public loadPage(savedData: string): void {
        ...
        // DiagramName.innerText = pageData.pageOptionList[0].name;
        this.pageOptionList = pageData.pageOptionList as PageOptions[];
        this.activePage = this.findPage(this.pageOptionList[0].name.toString());
    ...
    public loadDiagramSettings(): void {
            ...
            if (this.activePage != null){
                console.log( document.getElementById('diagramName').innerText);
            
               
                if (this.activePage.name.indexOf('page') < 0){
                    document.getElementById('diagramName').innerText = this.activePage.name + '.json';
                }
                else{
                    document.getElementById('diagramName').innerText = 'Untitled Diagram';
                }
                  
                // DiagramName.innerText = this.activePage.name;
